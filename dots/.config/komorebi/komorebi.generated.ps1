...
komorebic.exe identify-tray-application exe "ImageJ-win64.exe"
...
komorebic.exe identify-tray-application exe "matlab.exe"
komorebic.exe identify-border-overflow-application class "MATLAB"
